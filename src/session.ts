...
export async function loginSsc(INPUT: any) {
  ...
  try {
    if (INPUT.ssc_ci_token) {
      ...
      utils.debugObject(
        'Login to Software Security Center using Username Password'
      )
      ...
      core.info(
        'Existing default Software Security Center login session found.'
      )
    } else {
      core.info(
        'Login to Software Security Center ..... ' + utils.bgRed('Failure')
      )
      core.error(
    ...
    core.info(
      'Login to Software Security Center ..... ' + utils.bgGreen('Success')
    )
  } catch (err) {
    core.info(
      'Login to Software Security Center ..... ' + utils.bgRed('Failure')
